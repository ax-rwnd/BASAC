...
script -q -c '$CCNL_HOME/bin/ccn-lite-relay -v trace -s ndn2013 -u 9999 -x /tmp/mgmt-relay-b.sock -d $CCNL_HOME/test/ndntlv' /dev/null > $CCNL_LOGS/relay-b-$current_time.log &
sleep 2s
